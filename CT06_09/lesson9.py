...
# print(f"{1}st number: {num_1}")
# print(f"{2}nd number: {num_2}")
# print(f"{3}rd number: {num_3}")
...
# if all_even_odd == 3:
#     print("all numbers are even is True")
# else:
#     print("all numbers are even is False")

# if all_even_odd == 0:
#     print("all numbers are odd is True")
# else:
#     print("all numbers are odd is False") 
# --------------------------------------------------------------
...
# days = input("How many days has a book been borowed? ")
# if int(days) > 25:
#     print("Remember to  return your book!")
# --------------------------------------------------------------
...
# if int(apples) > 10:
#     print("You will get a 10% discount if you buy that many apples!")
#     price = int(apples) * 1 * (1 - 0.10)
#     print(f"${price}")
# else:
#     price = int(apples) * 1
#     print(price)
...
if num_apples > 5:
    one_apple = apple * (1 - 0.10)
    price = one_apple * num_apples

else:
    price = apple * num_apples


if num_oranges > 5:
    one_orange = orange * (1 - 0.10) 
    price = one_orange * num_oranges

else:
    price = orange * num_oranges
