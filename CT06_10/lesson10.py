...
guess_num = random.randint(1, 15)
chance = 10
for i in range(1, chance+1):
    guess = int(input(f"I have created a number between 1 to 15. You have {chance} tries. Ans: "))
    if guess == guess_num:
        print("That's it! You are good!")
        break
    else:
        print("Try again.")
        if guess > int(guess_num):
            print("Too high!")
        if guess < int(guess_num):
            print("Too low!")
# -------------------------------------------------------------------
...
# if num_1 < 0:
#     print(f"{num_1} is negative")
# else:
#     print(f"{num_1} is positive")
# -------------------------------------------------------------------
...
# guess_2 = input("Guess my number. It is between 1 and 10.")
# if guess_2 == num_2:
#     print("Congratulations!! You did it!")
# else:
#     print("Oops, better luck next time!")
...
# 1. Suggest reading indoors if temperature is below 20 degrees #if
# 2. Suggest cycling if temperature is between 20 and 30 degrees #elif
# 3. Suggest swimming if temperature is above 30 degrees #else
...
tempreature = int(input("What's the tempreature?"))
if tempreature > 30:
    print("I suggest you go swimming.")
elif tempreature >= 25 and tempreature <= 30:
    print("I suggest you go play basket ball.")
elif tempreature >= 20 and tempreature <= 24:
    print("I suggest you go cycling.")
else:
    print("I suggest you go read books indoors.")
# -------------------------------------------------------------------
...
chance = 10
for i in range(1, chance+1):
    guess = int(input(f"I have created a number between 1 to 10. You have {chance} tries. Ans: "))
    if guess == guess_num:
        print("That's it! You are good!")
        break
    else:
...
score = input("Give me the score of a student. ")
...
ang_pow = int(input("How much money do you have from CNY? "))

if ang_pow > 150:
    print("You can buy a: Gaming keyboard, New game, Gaming mouse, Gaming mouse pad, Snacks.")
elif ang_pow >= 100:
    print("You can buy a: New game, Gaming mouse, Gaming mouse pad, Snacks.")
elif ang_pow >= 50:
    print("You can buy a: Gaming mouse, Gaming mouse pad, Snacks.")
elif ang_pow >= 20:
    print("You can buy a: Gaming mouse pad, Snacks.")
else:
    print("You can buy : Snacks.")