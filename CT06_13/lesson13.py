...
# balance = 1000
# while True:
#     user = input("Would you like to Withdraw, Deposit, Check balance or Exit. ").lower()
#     if user == "withdraw":
#         user_draw = int(input("How much to withdraw? $"))
#         if user_draw <= balance:
#             balance -= user_draw
#             print(f"Success! You have ${balance} left!")
#         else:    
#             print("ERROR. INSUFICIENT AMOUNT OF MONEY")
#     elif user == "deposit":
...
# print(groceries)
# **Task 1c**:
# 1. You have just ran out of Ice. Add "Ice" in
# to the list.
...
for grocery in groceries:
    print(grocery)
    if grocery == "Apples":
        groceries[0] = f"{grocery}: I need 5 of these."
    elif grocery == "Carrots":
        groceries[2] = f"{grocery}: I need 3 of these. "
    elif grocery == "Grapes":
        groceries[6] = f"{grocery}: Get the FarmFresh brand. "
    else:
        print(grocery)
# -------------------------------------------------------------------
